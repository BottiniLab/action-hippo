...
dir_deriv   = '/data/pt_02747/action_hippo/data/derivatives/eyetracker/'

dir_responses = '/data/pt_02747_hippo/1_day_one/2_eyetracker/responses/trials/'
dir_responses_probes = '/data/pt_02747_hippo/1_day_one/2_eyetracker/responses/probe_trials/'
...
for sub in subs:
    ...
    for run in runs:
        ...
        # create a new column called 'onset' which is the time of the trial 

        # if it exists, use time_after_flip column
        if 'time_after_flip' in df_responses_run.columns:
            df_responses_run['onset'] = df_responses_run['time_after_flip']
        else:
            df_responses_run['onset'] = df_responses_run['start_time'] + 0.016 # 0.016 is the time to change screen

        # make onset column a float
        df_responses_run['onset'] = df_responses_run['onset'].astype(float)
        ...
        working_df['onset'] = working_df['start_time'] + working_df['rt']
        ...
        # =============================================================================
        # add fixations to events file (FIXATION CROSS, NOT EYE FIXATIONS)
        # =============================================================================
        ...
        df_responses_run = df_responses_run[['onset', 'duration', 'trial_type', 'position', 'stimulus']]
        ...
        df_responses_probes_run['onset'] = df_responses_probes_run['start_time']
        ...
        df_responses_run = df_responses_run[['onset', 'duration', 'trial_type', 'stimulus']]
        ...
        df_responses_run = df_responses_run[df_responses_run['trial_type'].isin(['1', '2', '3', '4', 'probe', 'stimulus', 'left', 'right', 'new_screen_left', 'new_screen_right', 'new_screen_missed'])]
        ...
        #df_responses_run_all = df_responses_run[df_responses_run['trial_type'].isin(['1', '2', '3', '4'])]
        ...
        save_dir = dir_deriv + sub
        if not os.path.exists(save_dir):
            os.makedirs(save_dir)
        # save the df_responses_run as a tsv file in the BIDS directory
        df_responses_run.to_csv(dir_deriv + sub + f'/{sub}_task-probe_run-0' + str(run) + '_events.tsv', sep = '\t', index = False)
