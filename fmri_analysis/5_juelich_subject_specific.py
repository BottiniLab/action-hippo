...
# file to run from within the nipype environment with ANTS enabled; from the MPI cbs system this is a mess - getserver -sL / ANTSENV / conda activate nipype / script.py (phew!)
