...
for sub_id in sub_ids:
    ...
    with open (dir_code+f'sub-{sub_id}_searchlight{append_str}.sh', 'w') as f_sl:
        f_sl.write(f'''\
#! /bin/bash
/data/u_eperon_software/anaconda3/envs/act_hippo_rsa/bin/python /data/pt_02747/action_hippo/code/10_single_subject_searchlight_partials_fourmodels.py {sub_id} {append_str}
