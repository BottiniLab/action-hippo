...
for sub in subs:
    ...
    for run in runs:
        ...
        # =============================================================================
        # NEW: IF WE WANT ADAPTATION
        # =============================================================================
        
        # add column 'modulation' which is all 0
        df_responses_run['modulation'] = 0

        # where 'trial_type' is '3', change 'modulation to -1
        df_responses_run['modulation'] = np.where(df_responses_run['trial_type'] == '3', -1, df_responses_run['modulation'])

        # where 'trial_type' is '2', change 'modulation to 1
        df_responses_run['modulation'] = np.where(df_responses_run['trial_type'] == '2', 1, df_responses_run['modulation'])

        # change 'trial_type' to 'scalarcode' where it is '1', '2', '3', '4'
        df_responses_run['trial_type'] = np.where(df_responses_run['trial_type'].isin(['1', '2', '3', '4']), 'scalarcode', df_responses_run['trial_type'])
